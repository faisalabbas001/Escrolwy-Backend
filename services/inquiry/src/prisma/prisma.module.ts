      ...
      providers: [
        PrismaService,
        {
          ...
          useFactory: async (
            ...
            // Construct DATABASE_URL for inquiry_db schema
            const databaseUrl = `postgresql://${username}:${password}@${host}:${port}/${database}?schema=inquiry_db`;
