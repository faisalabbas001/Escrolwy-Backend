 ...
 * Prisma Service
 *
 * Manages database connection lifecycle for the Reporting Service.
 * Connects to reporting_db schema in the shared PostgreSQL instance.
 *
 * Best Practices:
...
export class PrismaService
    ...
    async onModuleInit() {
        try {
            ...
            await this.$connect();
            this.logger.log('✅ Connected to PostgreSQL (reporting_db schema)');
        } catch (error) {
