 ...
 * Prisma Service
 *
 * Manages database connection lifecycle for the Notification Service.
 * Connects to notification_db schema in the shared PostgreSQL instance.
 *
 * Best Practices:
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  async onModuleInit() {
    try {
      ...
      await this.$connect();
      this.logger.log("✅ Connected to PostgreSQL (notification_db schema)");
    } catch (error) {
