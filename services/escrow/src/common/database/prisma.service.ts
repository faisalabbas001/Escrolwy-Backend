 ...
 * Prisma Service
 *
 * Manages database connection lifecycle for the Escrow Service.
 * Connects to escrow_db schema in the shared PostgreSQL instance.
 *
 * Best Practices:
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  async onModuleInit() {
    try {
      ...
      await this.$connect();
      this.logger.log('✅ Connected to PostgreSQL (escrow_db schema)');
    } catch (error) {
