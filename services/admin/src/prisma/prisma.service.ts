 ...
 * Prisma Service
 *
 * Manages database connection lifecycle for the Admin Service.
 * Connects to admin_db schema in the shared PostgreSQL instance.
 *
 * Best Practices:
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  async onModuleInit() {
    try {
      ...
      await this.$connect();
      this.logger.log('✅ Connected to PostgreSQL (admin_db schema)');
    } catch (error) {
